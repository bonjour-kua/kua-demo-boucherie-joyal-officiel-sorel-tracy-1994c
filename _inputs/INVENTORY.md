# Inventaire des inputs disponibles — Boucherie Joyal Officiel Sorel-Tracy
...
| `_inputs/photos/manifest.json` | Catalogue des 10 photo(s) classifiée(s) avec leur rôle | Avant de composer les sections |
